...
public class JManageMoney extends AbstractJInternalFrame {
	 ...
	 */
	public JManageMoney(AbstractJInternalFrame jCicIFParent, boolean modal, int executingMode, String title,
	...
	public JManageMoney(JDesktopPane desktop) {
		super(desktop);
	...
	private JButton getJButtonSearch() {
		if (btnFilterTicket == null) {
			...
			btnFilterTicket
					.setIcon(new ImageIcon(JManageMoney.class.getResource("/img/icon-search.png")));
		}
	...
	private JButton getBtnSaveTicket() {
		if (btnSaveTicket == null) {
			...
			btnSaveTicket
					.setIcon(new ImageIcon(JManageMoney.class.getResource("/img/icon-save.png")));
		}
